    ...
    <div className={`app-frame${railCollapsed ? " rail-collapsed" : ""}`}>
      ...
      <nav className="rail">
        ...
        <div className="sec settings">
          ...
          >
            {/* The full feather gear — the old hand-shortened transcription
                dropped the right-middle tooth (its `H21` segment) and used
                large-arc flags that ballooned the corner lobes, so the gear
                drew lopsided from the day it was written (`gear-1`, found by
                the USER's eye 2026-08-09 — the eleven habit icons got real
                lucide data 2026-08-02; the door icons' hand paths never got
                the same sweep). */}
